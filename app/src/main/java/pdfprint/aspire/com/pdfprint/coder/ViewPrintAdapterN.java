...
/**
 * Created by sunisha on 4/5/2018.
 */

public class ViewPrintAdapterN extends PrintDocumentAdapter {
    ...
    public ViewPrintAdapterN(Context context, View view, int pageCount) {
        mContext = context;
        mView = view;
